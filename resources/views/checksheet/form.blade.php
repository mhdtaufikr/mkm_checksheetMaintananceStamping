                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="revision" name="revision" placeholder="Enter Revision" required>                                   
                                    </div>
                                </div>
                                <hr>
                                <div class="col-md-4 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="op_number" name="op_number" placeholder="Enter OP No." required>                                   
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="planning_date" name="planning_date" placeholder="Enter Planning Date" required>                                   
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="process" name="process" placeholder="Enter Process" required>                                   
                                    </div>
                                </div>
                                <div class="col-md-4 mb-2">
                                    <div class="form-group">
